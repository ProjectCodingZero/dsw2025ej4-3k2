...
public abstract class Mamifero {
    ...
    protected Mamifero(TipoAlimentacion tipoAlimentacion, int edad, double peso, Especie especie, Sector sector, Pais pais) throws IllegalArgumentException, InvalidPropertiesFormatException {
